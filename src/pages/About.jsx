            ...
            <div className="relative z-10 pt-5 pb-20">
              ...
              <div className="pt-10 max-w-[42rem] px-5">
                <h1 className="text-left font-Mona font-bold text-white text-4xl leading-20 pb-2  ">
                  <GoQuestion className="inline align-bottom text-4xl" /> About Locate.Dev
                </h1>
                <div className="  text-left font-Hublot text-gray-300 text-lg leading-20 pt-4 pb-4 ">
                  Locate.Dev connects you to the heartbeat of software development communities around the world, offering businesses and individuals the ability to identify leading
                  ...
                  <p className="text-left font-Hublot text-gray-300 text-lg leading-20 pt-2">
                    I started Locate.Dev as I was finding it difficult to find other developers in my city who were excelling in the industry. Platforms like LinkedIn, GitHub and
                ...
                <div className="  text-left font-Hublot text-gray-300 text-lg  leading-20 pt-4 pb-4 ">
                  ...
                  For those looking to build a team or collaborate on projects, Locate.Dev's ability to focus on local talent simplifies the search for compatible and skilled partners.{" "}
                </div>{" "}
                <h1 className="pt-10 pb-2 text-left font-Mona font-bold text-white text-4xl leading-20  ">
                  <GoGitPullRequestClosed className="inline align-bottom" /> What Makes Locate.Dev Different?
                </h1>
                <div className="  text-left font-Hublot text-gray-300 text-lg  leading-20 pt-4 pb-4 ">
                  <h2 className="text-white font-bold text-xl pb-1">• Scope & Focus</h2>
                  Unlike LinkedIn, GitHub or Crunchbase, which generally focus on the big picture, Locate.Dev can emphasize local software development communities, offering a unique
                  lens into regional talent and trends. <h2 className="text-white font-bold text-xl pt-4 pb-1">• Objective Metrics</h2>
                  Locate.Dev uses a combination of followers, public repositories, and commits to objectively rank developers. This differs from LinkedIn, where visibility often
                  ...
                  While platforms like GitHub focus primarily on code repositories, Locate.Dev provides a more holistic view of a developer, including their social media presence,
                  ...
                  Locate.Dev simplifies the process of finding leading developers in a specific region, a task that can be challenging on more generalized platforms like LinkedIn. The
                  platform also accomadates for technical and non-technical users alike.
                </div>{" "}
              </div>
            </div>
            <div className="flex justify-center">
  <a href="https://www.instagram.com/monusingh8217/" target="_blank" rel="noopener noreferrer">
   <img
    ...
    />
          ...
          <a href="https://github.com/monu404" target="_blank" rel="noopener noreferrer" className="text-white font-Hublot leading-5 tracking-wider pb-2 jack-sheehy">
          🔥 Monu Kumar :) <br />
            ©2024
          </a>
        </div>
